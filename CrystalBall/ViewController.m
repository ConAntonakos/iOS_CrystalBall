...
- (void)viewDidLoad
{
    ...
    self.imageView.animationImages = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"cball00001"], [UIImage imageNamed:@"cball00002"],
...
- (void)makePrediction
{
    NSUInteger index = arc4random() % self.predictionArray.count;
